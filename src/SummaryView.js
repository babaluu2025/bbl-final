              ...
              >
                ...
                <div style={{ 
                  ...
                  <div style={{
                    ...
                    <span style={{ fontWeight: 'bold' }}>🧾 Fiskalni:</span>
                    <span style={{ 
                      fontWeight: 'bold', 
                      color: '#1f2937',
                      fontSize: '16px'
                  ...
                  <div style={{
                    ...
                    <span style={{ fontWeight: 'bold' }}>💵 Sunmi:</span>
                    <span style={{ 
                      fontWeight: 'bold', 
                      color: '#1f2937',
                      fontSize: '16px'
                  ...
                  <div style={{
                    ...
                    <span style={{ fontWeight: 'bold' }}>📊 Pazar:</span>
                    <span style={{ 
                      fontWeight: 'bold', 
                      color: '#1f2937',
                      fontSize: '16px'
                  ...
                  <div style={{
                    ...
                    <span style={{ fontWeight: 'bold' }}>📉 Stvarni pazar:</span>
                    <span style={{ 
                      fontWeight: 'bold', 
                      color: '#1f2937',
                      fontSize: '16px'
